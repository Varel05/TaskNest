        ...
        <form method="POST" action="{{ isset($project) ? route('projects.update', $project->id) : route('projects.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" 
                    ...
                    value="{{ $project->name ?? '' }}" 
                    required 
                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring focus:ring-green-200 focus:border-green-500">
            </div>
            ...
            <div>
                ...
                <textarea id="description" 
                    ...
                    rows="4" 
                    required 
                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring focus:ring-green-200 focus:border-green-500">{{ $project->description ?? '' }}</textarea>
            </div>
